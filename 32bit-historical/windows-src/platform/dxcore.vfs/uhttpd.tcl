...
proc uhttpd::create {port args} {
    ...
    if {$port>0} {
        ...
        set port [lindex [fconfigure [socket -server [namespace current]::Accept 0] -sockname] 2]
    }
...
proc uhttpd::Read {s} {
    ...
    set data(root) $Httpd(-root) ;# makes this available to "routes"
    set data(port) $Httpd(port)  ;# likewise
